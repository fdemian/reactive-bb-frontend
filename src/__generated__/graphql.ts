...
export type GetUserQuery = { __typename?: 'Query', getUser?: { __typename?: 'User', id: number, username: string, avatar?: string | null, type: string, fullname: string, email: string, status?: string | null, about?: string | null, banned: boolean, banExpires?: any | null, banReason?: string | null } | null };

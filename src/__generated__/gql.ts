...
type Documents = {
  ...
  '\n  query GetPinnedTopics {\n    pinnedTopics {\n      id\n      name\n      views\n      replies\n      created\n      closed\n      pinned\n      user {\n        id\n        avatar\n        username\n      }\n      category {\n        id\n        name\n      }\n    }\n  }\n': typeof types.GetPinnedTopicsDocument;
  '\n  mutation PinTopic($topic: Int!) {\n    pinTopic(topic: $topic)\n  }\n': typeof types.PinTopicDocument;
  '\n  query GetUser($id: Int!) {\n    getUser(id: $id) {\n      id\n      username\n      avatar\n      type\n      fullname\n      email\n      status\n      about\n      banned\n      banExpires\n      banReason\n    }\n  }\n': typeof types.GetUserDocument;
  '\n  query GetLikesByUser($id: Int!) {\n    likesByUser(id: $id) {\n      id\n      post {\n        id\n        topicId\n        content\n      }\n    }\n  }\n': typeof types.GetLikesByUserDocument;
  '\n  query GetTopicsByUser($id: Int!) {\n    topicsByUser(id: $id) {\n      id\n      name\n    }\n  }\n': typeof types.GetTopicsByUserDocument;

...
const TopicsList = (props: TopicsListParams) => {
    const { topics, pinnedTopics, isMobile, userType, t } = props;
                ...
                <List.Item
                    ...
                    actions={
                        isMobile
                            ...
                            : [
                                  <Statistic
                                      key="author-statistic"
                                      title={t('author')}
                                      value={item.user.username}
                                  />,
                                  <Statistic
                                      key="created-statistic"
                                      title={t('created')}
                                      value={getDate(item.created)}
                                  />,
                                  <Statistic
                                      key="replies-statistic"
                                      title={t('replies')}
                                      value={item.replies}
                                  />,
                                  <Statistic
                    ...
                    <List.Item.Meta
                        ...
                        title={
                            <>
                                ...
                                >
                                    {isMobile ? (
                                        <p className="topic-item-title-mobile">
                                            {item.name}
                                        </p>
                                    ) : (
                        ...
                        description={
                            isMobile ? (
                                <p className="category-date-mobile">

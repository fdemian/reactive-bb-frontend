...
const App = () => {
    ...
    const { config, oauth } = data && data.config ? data.config : { config: {}, oauth: {} };
    const { description, name, items_per_page, logoURL, faviconURL, faviconType } = config;
    ...
    <HelmetProvider>
        <ConfigProvider {...appConfigProps}>
           <Helmet>
               <link rel="icon" type={faviconType} href={faviconURL} data-rh="true" />
